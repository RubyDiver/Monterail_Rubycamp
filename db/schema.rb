...
ActiveRecord::Schema.define(version: 20_210_614_115_300) do
  ...
  create_table 'cinema_halls', force: :cascade do |t|
    ...
    t.index ['ticket_id'], name: 'index_cinema_halls_on_ticket_id'
  end
  ...
  create_table 'ticket_desks', force: :cascade do |t|
    ...
    t.datetime 'updated_at', precision: 6, null: false
    t.bigint 'ticket_id'
    t.index ['ticket_id'], name: 'index_ticket_desks_on_ticket_id'
  end
